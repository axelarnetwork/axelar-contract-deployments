...
if (require.main === module) {
  ...
  program
    ...
    .addOption(
      new Option(
        "-m, --multisign",
        "active wallet is a signer of the target XRPL multisig account",
      ).default(false),
    )
    .addOption(
      new Option(
        "--account <account>",
        "XRPL account from which to create a trust line (default: active wallet)",
      ),
    )
    .addOption(
      new Option("--limit <limit>", "trust line limit").default("1000000000"),
    )
