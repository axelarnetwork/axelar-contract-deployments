...
if (require.main === module) {
  ...
  program
    ...
    .addOption(
      new Option(
        "-m, --multisign",
        "active wallet is a signer of the XRPL multisig account being configured",
      ).default(false),
    )
    .addOption(
      new Option(
        "--account <account>",
        "XRPL account to configure (default: active wallet)",
      ),
    )
    .addOption(
      new Option("--transferRate <transferRate>", "account transfer rate"),
    )
