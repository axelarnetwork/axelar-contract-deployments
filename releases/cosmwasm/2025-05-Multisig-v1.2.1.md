...
```bash
ts-node cosmwasm/contract.ts store-code -c Multisig -t "Upload Multisig contract v1.2.1" -d "Upload Multisig contract v1.2.1" --instantiateAddresses $INIT_ADDRESSES --version 1.2.1 --governance
```
