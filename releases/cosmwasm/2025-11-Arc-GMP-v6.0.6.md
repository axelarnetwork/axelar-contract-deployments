...
| -------------------- | ----------------------------------------------- | --------- |
| **Devnet-amplifier** | `axelar1zlr7e5qf3sz7yf890rkh9tcnu87234k6k7ytd9` | `v1.0.0`  |
| **Stagenet**         | `axelar12qvsvse32cjyw60ztysd3v655aj5urqeup82ky` | `v1.0.0`  |
| **Testnet**          | `axelar1wxej3l9aczsns3harrtdzk7rct29jl47tvu8mp` | `v1.0.10` |
| **Mainnet**          | `axelar1nctnr9x0qexemeld5w7w752rmqdsqqv92dw9am` | `v1.0.0`  |
...
1. Create reward pools for Voting Verifier and Multisig
    ...
    | -------------------- | ---------------- | ------------------------- | ------------------- |
    | **Devnet-amplifier** | `500`            | `[\"7\", \"10\"]`         | `100`               |
    | **Stagenet**         | `3000`           | `[\"7\", \"10\"]`         | `100`               |
    | **Testnet**          | `3000`           | `[\"7\", \"10\"]`         | `100`               |
    | **Mainnet**          | `47250`          | `[\"8\", \"10\"]`         | `3424660000`        |
