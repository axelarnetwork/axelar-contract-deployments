...
wget $RELEASES_BASE_URL/releases/cosmwasm/gateway/1.0.0/gateway.wasm --directory-prefix=$ARTIFACT_PATH
```
...
wget -O checksums.txt $RELEASES_BASE_URL/releases/cosmwasm/gateway/1.0.0/checksums.txt
...
```
TBD  wasm/voting_verifier.wasm
TBD  wasm/multisig_prover.wasm
TBD  wasm/gateway.wasm
```
