...
[Release](https://github.com/commonprefix/axelar-amplifier/releases/tag/xrpl-voting-verifier-v1.3.0)
...
- This rollout upgrades XRPLVotingVerifier from `v1.2.0` to `v1.3.0`
...
```bash
{"contract":"xrpl-voting-verifier","version":"1.3.0"}
```
