...
```bash
node cosmwasm/submit-proposal.js store -c InterchainTokenService -t "Upload InterchainTokenService contract v1.2.0" -d "Upload InterchainTokenService contract v1.2.0" --instantiateAddresses $INIT_ADDRESSES -a ./wasm
```
