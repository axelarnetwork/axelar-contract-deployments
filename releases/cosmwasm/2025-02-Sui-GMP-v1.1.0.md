...
* Note: This Release doc is only for Sui on devnet-amplifier. And sui is to be integrated as `sui-2` on devnet-amplifier.

### Pre-requisites

Deploy the [External Gateway](../sui/2025-02-Sui-v2.1.0.md) address, as `VotingVerifier` needs the `sourceGatewayAddress` which is the External Gateway address.
...
The [Sui GMP checklist](../sui/2025-02-Sui-v6.0.4.md) will test GMP call.
