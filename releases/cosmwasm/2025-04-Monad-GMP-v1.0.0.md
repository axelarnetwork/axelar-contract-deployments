...
<!-- TODO -->
<!-- - [Amplifier Releases]()
- [VotingVerifier v1.1.0]()
- [Gateway v1.1.1]()
- [MultisigProver v1.1.1]() -->

## Background

These are the instructions for deploying Amplifier contracts for the Monad connection.

### Pre-requisites

Predict the [External Gateway](../evm/2025-03-Monad-GMP-v1.0.0.md) address, as `VotingVerifier` needs the `sourceGatewayAddress` which is the External Gateway address.
...
<!-- TODO: Get deposit value & reward amount for Monad -->
...
The [Monad GMP checklist](../evm/2025-03-Monad-GMP-v1.0.0.md) will test GMP call.

<!-- TODO - Axelar Transceiver -->
