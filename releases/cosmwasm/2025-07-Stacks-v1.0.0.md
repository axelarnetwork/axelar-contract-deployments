...
```bash
mkdir $ARTIFACT_PATH
wget $RELEASES_BASE_URL/releases/cosmwasm/voting-verifier/1.0.0/voting_verifier.wasm -O $ARTIFACT_PATH/stacks_voting_verifier.wasm
wget $RELEASES_BASE_URL/releases/cosmwasm/multisig-prover/1.0.0/multisig_prover.wasm -O $ARTIFACT_PATH/stacks_multisig_prover.wasm
