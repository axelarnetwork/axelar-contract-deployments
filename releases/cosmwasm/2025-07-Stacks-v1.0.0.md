...
- [StacksVotingVerifier v1.0.0 TBD](https://github.com/Trust-Machines/axelar-amplifier/pull/8)
- [Gateway v1.1.1](https://github.com/axelarnetwork/axelar-amplifier/releases/tag/gateway-v1.1.1)
- [StacksMultisigProver v1.0.0 TBD](https://github.com/Trust-Machines/axelar-amplifier/pull/8)
- [ItsStacksTranslator v1.0.0 TBD](https://github.com/Trust-Machines/axelar-amplifier/pull/8)
...
| **Stagenet**         | `amplifier`   | `["51", "100"]`   | `["51", "100"]`    | `1`                  | `hex_tx_hash_and_event_index` | `stacks`        | `stacks`  |
...
```bash
mkdir $ARTIFACT_PATH
wget $RELEASES_BASE_URL/pre-releases/cosmwasm/e79e93a8/voting_verifier.wasm --directory-prefix=$ARTIFACT_PATH
wget $RELEASES_BASE_URL/pre-releases/cosmwasm/e79e93a8/multisig_prover.wasm --directory-prefix=$ARTIFACT_PATH
wget $RELEASES_BASE_URL/pre-releases/cosmwasm/e79e93a8/its_stacks_translator.wasm --directory-prefix=$ARTIFACT_PATH
```

2. Download and verify checksum.

```bash
wget -O checksums.txt $RELEASES_BASE_URL/pre-releases/cosmwasm/e79e93a8/checksums.txt
...
9eed64f761969979fe0be46e26b42f958f2103ebfdeb7edc76d393dfe0e691c0  wasm/its_stacks_translator.wasm
```
...
```bash
ItsStacksTranslator(v1.0.0) -> "storeCodeProposalCodeHash": "TBD"
