...
wget $RELEASES_BASE_URL/pre-releases/cosmwasm/f863b56/gateway.wasm --directory-prefix=$ARTIFACT_PATH
...
197ebeab2e79a6ddc184031c58602f75b6354649d72b57a095ec24d0d3d43d43  wasm/gateway.wasm
...
- Confirm `StacksAbiTransformer(v1.0.0)`, `StacksVotingVerifier(v1.0.0)`, `StacksGateway(v1.0.0)` and `StacksMultisigProver(v1.0.0)` contracts are
  already
  stored in `$ENV.json`:
...
6. Register `StacksGateway` on the Router.
