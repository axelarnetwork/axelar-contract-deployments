...
- **Latest Prebuilt binaries:** Available on the [release page](https://github.com/axelarnetwork/axelar-core/releases/tag/v1.3.4). For Linux, we recommend the statically linked binary [axelard-linux-amd64-v1.3.4-static](https://github.com/axelarnetwork/axelar-core/releases/download/v1.3.2/axelard-linux-amd64-v1.3.4-static) which runs on any Linux distribution without requiring libwasmvm to be installed on your system.
