...
cat > proposal.json << 'EOF'
{
  ...
  "metadata": "",
  "deposit": "[deposit]",
  "title": "Update EVM Voting Grace Period for [CHAIN_NAME] (v1.3.2)",
...
| **Mainnet** | 421 | [21163210](https://www.mintscan.io/axelar/block/21163210) | 2 PM |
...
7. If your process runs out of memory during the upgrade, increase your system RAM to at least `64GB`. Once you do, the upgrade will restart to beginning and progress will be lost
...
- **Note:** After all modules finish upgrading, block production will resume only after 67% of validators by stake have completed the upgrade. Depending on validator response rate, this can add an additional **30–90 minutes** to the overall migration duration.
