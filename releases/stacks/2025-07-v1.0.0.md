...
| **Stagenet**         | ST2ZY2VGBZQM6CS48DRX58PE3CMQEZP0BNE0F0GW6 | ST2ZY2VGBZQM6CS48DRX58PE3CMQEZP0BNE0F0GW6 | `300`                  | `15`                      | 
...
| Network              | `operator`                                | `trustedChains`        |
|----------------------|-------------------------------------------|------------------------|
| **Devnet-amplifier** | "deployer wallet address"                 | `avalanche-fuji,sui-2` |
| **Stagenet**         | ST2ZY2VGBZQM6CS48DRX58PE3CMQEZP0BNE0F0GW6 | `TBD`                  |
...
| **Stagenet**         | ST2ZY2VGBZQM6CS48DRX58PE3CMQEZP0BNE0F0GW6 |
...
> is currently not used. The `ownership` defaults to the initial contract deployer

- for GasService

```bash
ts-node stacks/commands.js transfer-ownership AxelarGasService "[owner address]"
```
...
> **_NOTE:_** Make sure to have the `PRIVATE_KEY` env var set to an EVM wallet private key with funds for the network
> you are using.
...
This needs to be done with initial deployer wallet which deployed the other contracts. If a different wallet is used,
the Governance contract code will have to be updated to contain correct trait references to the other contracts.
