...
- Install Stellar CLI compatible with the soroban-sdk version in [Cargo.toml](https://github.com/axelarnetwork/axelar-cgp-stellar/blob/main/Cargo.toml)
...
6. After deploying stellar contracts, ensure that you deploy [Stellar GMP Amplifier](../cosmwasm/2025-01-Stellar-GMP-v1.0.0.md).

7. Rotate genesis verifier set on Stellar Gateway
