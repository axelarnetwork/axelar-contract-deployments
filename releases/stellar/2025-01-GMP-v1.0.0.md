...
```bash
node stellar/deploy-contract.js deploy AxelarExample --wasm-path ../axelar-cgp-stellar/target/wasm32-unknown-unknown/release/stellar_axelar_example.optimized.wasm --use-dummy-its-address
```
