...
- [Crates](https://crates.io/crates/stellar-interchain-token-service/1.1.3)
- [Releases](https://github.com/axelarnetwork/axelar-amplifier-stellar/releases/tag/stellar-interchain-token-service-v1.1.3)

## Background

- This is the v1.1.3 Stellar ITS release.

Contract changes in the release:

- emit data_hash instead of data in InterchainTransferSentEvent ([#342](https://github.com/axelarnetwork/axelar-amplifier-stellar/pull/342))
...
```bash
node stellar/deploy-contract.js upgrade InterchainTokenService --version 1.1.3
```
