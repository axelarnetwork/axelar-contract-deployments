...
```bash
ts-node evm/interchainTokenFactory.js deploy-interchain-token --name "testC" --symbol "TESTC" --decimals 18 --initialSupply <initialSupply> --minter <minter> --chainNames avalanche --env <env> --salt "testC"

https://snowtrace.io/tx/0xde5796810bd40a35528c00f0ad67d5d36819470104e5f35c3d7af4e7fe4d6d19
```

```bash
ts-node evm/interchainTokenFactory.js deploy-remote-interchain-token --destinationChain stellar --chainNames flow --env <env> --salt "test55"
