...
```bash
ts-node evm/interchainTokenFactory.js deploy-interchain-token --name "testa1" --symbol "TESTA1" --decimals 18 --initialSupply [initialSupply] --minter [minter]  --chainNames avalanche-fuji --env [env] --salt "testa1"
...
ts-node evm/interchainTokenFactory.js deploy-remote-interchain-token --destinationChain stellar-2025-q1 --chainNames avalanche-fuji --env [env] --salt "testa1"
