...
```bash
ts-node evm/interchainTokenFactory.js deploy-interchain-token --name "test3" --symbol "TEST3" --decimals 18 --initialSupply 0 --minter "" --chainNames flow --env stagenet --salt test3

deployInterchainToken tx: 0x9356315fa63f62f069956b1dba9dd2e5019b0029224d510278697f6b82d8c0fc
```

```bash
ts-node evm/interchainTokenFactory.js deploy-remote-interchain-token --destinationChain stellar-2025-q1 --chainNames flow --env stagenet --salt test3
