...
```bash
npm run script stellar/deploy-contract.js upgrade AxelarOperators --version 1.1.1 --migration-data '["GAY6RYZLHDSYQ7Y3X2CRSOTB6PVXAQ3IRTQFIAATYSP2TX7N25HVSJEV","GBNSB3AHRLVVXBWZFCFSWBUG6RZHNSOIDIH7VGKL2GHVFXFVV3I6I5AM"]'
...
```bash
npm run script stellar/gmp.js send avalanche 0xba76c6980428A0b10CFC5d8ccb61949677A61233 0x1234 --gas-amount 100000000
...
```bash
npm run script evm/gateway.js -n flow --action callContract --destinationChain stellar-2025-q1 --destination CDMT7AQM5WE7KGVS2257SGDZH6TA7KBFHQM2N4VWOWSWUV3GACR4YU3H --payload 0x1234
