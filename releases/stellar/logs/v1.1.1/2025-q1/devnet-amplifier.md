...
```
node stellar/deploy-contract.js upgrade InterchainTokenService --version 1.1.1 --migration-data '{"newTokenManagerWasmHash":"9883cdb6740d685007a88dbd5a1269ffc1550a81a182fed5de3748356d0e342c","newInterchainTokenWasmHash":"71648e1b8ee1231ea03c096257ed3c6d55478effbfab77b8e587a5139ab84cbe"}'
...
```
node stellar/its.js deploy-remote-interchain-token 0x1234 avalanche-fuji --gas-amount 10000000
...
```
node evm/interchainTokenFactory.js --action deployInterchainToken -n avalanche-fuji --destinationChain stellar-2025-q1 --salt "testa1" --name "testa1" --symbol "TESTA1" --decimals 18
...
node evm/interchainTokenFactory.js --action deployRemoteInterchainToken -n avalanche-fuji --destinationChain stellar-2025-q1 --salt "testa1" --gasValue 1000000000000000000
