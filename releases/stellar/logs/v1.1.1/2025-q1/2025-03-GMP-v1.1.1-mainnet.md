...
```bash
npm run script stellar/deploy-contract.js upgrade AxelarGateway --version 1.1.1 --migration-data '[["axelar","0xe75bfad0ac5c972ac4053d11bade19d182c4799f22872c3cca8090e07
...
```bash
npm run script stellar/deploy-contract.js upgrade AxelarOperators --version 1.1.1 --migration-data '["GBAGPWP4GXOB4PD62KLUGOWKWVBYSUQOO37XHB7PNYWKVHSDAVO4HWHD","GDK4ZR7W
...
```bash
npm run script evm/gateway.js -n avalanche --action callContract --destinationChain stellar --destination CDMT7AQM5WE7KGVS2257SGDZH6TA7KBFHQM2N4VWOWSWUV3GACR4YU3H --payload 0x1234
