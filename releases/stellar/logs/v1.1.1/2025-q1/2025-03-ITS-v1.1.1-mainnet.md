...
```bash
node stellar/its.js deploy-interchain-token TEST132 test132 18 0x891012 100000000

Interchain Token Deployed tx: d62430f764ceae5090b25648bcae5c360e6a256d042ed9b8521a1a8da7fbd7af

tokenId: 1e74107ea6a9e72565209934fd1f43fba34bde9f3dfccef365f1480efbf95025
```

```bash
node stellar/its.js deploy-remote-interchain-token 0x891012 flow --gas-amount 50000000
...
```bash
node evm/interchainTokenFactory.js --action deployInterchainToken -n avalanche --destinationChain stellar --salt "testC" --name "testC" --symbol "TESTC" --decimals 18
