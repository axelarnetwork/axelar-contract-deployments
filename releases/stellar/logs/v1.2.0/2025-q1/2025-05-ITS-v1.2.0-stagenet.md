...
```bash
node stellar/its.js deploy-remote-interchain-token 0x112233 avalanche --gas-amount 10000000
...
```bash
node stellar/its.js interchain-transfer 0x96efc3f5494b452964196fa62dd5a3a3b6b895d317f8f0172ce55c8286ef9fe7 avalanche 0x0FCb262571be50815627C16Eca1f5F3D342FF5a5 1 --data 0x1234 --gas-amount 10000000

https://stagenet.axelarscan.io/gmp/48ed1aabc44f033c859864f4bf990d03db6fe123e6faf322da5d845d50b4650f
```
