...
ts-node evm/interchainTokenFactory.js deploy-interchain-token --name "test" --symbol "TST" --decimals [decimals] --initialSupply 10000 --minter [wallet] --chainNames [chain_name] --env [env] --salt "salt12345"
...
ts-node evm/interchainTokenFactory.js register-custom-token --tokenAddress [tokenAddress] --tokenManagerType 4 --operator [wallet] --chainNames [chain_name] --env [env] --salt "salt6789"


# Link to remote token. Ensure GMP call is executed
ts-node evm/interchainTokenFactory.js link-token --destinationChain chain2 --destinationTokenAddress [remote token address] --tokenManagerType 4 --linkParams "0x" --chainNames [chain_name] --env [env] --salt "salt6789"
```
