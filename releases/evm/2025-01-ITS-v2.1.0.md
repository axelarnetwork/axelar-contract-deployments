...
node evm/deploy-its.js -s "ITS v2.1.0 devnet-amplifier" -m create2 --reuseProxy
...
node evm/deploy-its.js -s "ITS v2.1.0 consensus devnet-amplifier" -m create2 --reuseProxy
...
```bash
# Deploy new implementation
node evm/deploy-its.js -s "ITS v2.1.0" -m create2 --reuseProxy
