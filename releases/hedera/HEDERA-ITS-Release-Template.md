...
CHAIN=<chain name>
# hedera specific
HEDERA_ID=<hedera account id in format 0.0.xxxxx>
HEDERA_NETWORK=<local|previewnet|testnet|mainnet>
```
...
```bash
ts-node hedera/fund-whbar.js --to <its_address> --whbarAddress <whbar_address> --amount 10
```
