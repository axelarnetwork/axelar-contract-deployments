...
| -------------------- | -------------- | --------------------------------------------- |
| **Devnet Amplifier** | **Devnet**     | `itsmM2AJ27dSAXVhCfj34MtnFqyUmnLF7kbKbmyqRQA` |
| **Stagenet**         | **Testnet**    | `` |
| **Testnet**          | **Testnet**    | `` |
| **Mainnet**          | **Mainnet**    | `` |
...
1. Interchain Token Transfer for Native Interchain Token:
    ...
    **Step 2:** For the account *that was created by ITS*, retrieve its account info:
...
1. Deploy Native Interchain Token:
    ...
    ts-node evm/interchainTokenFactory.js deploy-remote-interchain-token \
...
1. Interchain Token Transfer for Native Interchain Token:
    ...
    ```sh
    ts-node evm/its.js interchain-transfer $CHAIN <TOKEN_ID> <SOLANA_MINT_TOKEN_MANAGER_ADDRESS> <TOKEN_AMOUNT> --chainNames <SOURCE_CHAIN>
    ```
...
1. Interchain Token Transfer for Canonical Token:
    ...
    ```sh
    ts-node evm/its.js interchain-transfer $CHAIN <TOKEN_ID> <SOLANA_MINT_TOKEN_MANAGER_ADDRESS> <TOKEN_AMOUNT> --gasValue <GAS_VALUE> --chainNames <SOURCE_CHAIN>
    ```
...
1. Link Custom Token:
    ...
    ```sh
    ts-node evm/its.js interchain-transfer $CHAIN <TOKEN_ID> <SOLANA_MINT_TOKEN_MANAGER_ADDRESS> <AMOUNT> --gasValue <GAS_VALUE> --chainNames <SOURCE_CHAIN>
    ```
