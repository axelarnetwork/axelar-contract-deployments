...
| -------------------- | ----------- | -------------- | --------------------------------------------- |
| **Devnet Amplifier** | Gateway     | **Devnet**     | `gtwiF7Bamsq5zBQCnKjK7kHfmBQe7StQE9VPucWrtmA` |
| **Devnet Amplifier** | Gas Service | **Devnet**     | `gas5H48imY2w1j6e6x3EvVxKFtyTuWFhw6pgS5VAPLu` |
| **Devnet Amplifier** | Governance  | **Devnet**     | `govxuD1tYtyiGjXiNJBFtRYmuhA68VwJGpGXKADSJxA` |
| **Devnet Amplifier** | Multicall   | **Devnet**     | `` |
| **Devnet Amplifier** | Operators   | **Devnet**     | `oprgv1Fc3i2tRLGpKtbMB8oKnQHtWyossGYUfpfPzN6` |
| **Devnet Amplifier** | Memo        | **Devnet**     | `memxUmZBzudVtrqZGPTuAyKbSZt2LAMkB2itKaUriQR` |
...
1. Send a memo message cross-chain via the `Memo` program (which internally calls the Gateway):

    ```sh
    solana/cli send memo send-memo \
