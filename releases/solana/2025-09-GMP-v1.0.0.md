...
- Add the below addresses as they are generated during the release process.

### Devnet Amplifier

| **Axelar Env**       | **Program** | **Solana Env** | **Address**                                   |
| -------------------- | ----------- | -------------- | --------------------------------------------- |
...
| **Axelar Env** | **Program** | **Solana Env** | **Address**                                    | **Version** |
| -------------- | ----------- | -------------- | ---------------------------------------------- | ----------- |
| **Stagenet**   | Gateway     | **Testnet**    | `gtwYHfHHipAoj8Hfp3cGr3vhZ8f3UtptGCQLqjBkaSZ`  | `0.1.11`    |
| **Stagenet**   | Gas Service | **Testnet**    | `gasgy6jz24wrfZL98uMy8QFUFziVPZ3bNLGXqnyTstW`  | `0.1.11`    |
| **Stagenet**   | Operators   | **Testnet**    | `oprNyqaxdvxs9s3Ngyi1gHqXeM2QLTv8skVPCcqmekx`  | `0.1.11`    |
| **Stagenet**   | Memo        | **Testnet**    | `mem4E22pPgkbHAvoUYHa7HybBgUKn6jFjvj1YnPdkaq`  | `0.1.11`    |
| **Stagenet**   | Governance  | **Testnet**    | N/A                                            |             |
| **Stagenet**   | Multicall   | **Testnet**    | N/A                                            |             |

### Testnet

| **Axelar Env** | **Program** | **Solana Env** | **Address**                                    | **Version** |
| -------------- | ----------- | -------------- | ---------------------------------------------- | ----------- |
| **Testnet**    | Gateway     | **Devnet**     | `gtwJ8LWDRWZpbvCqp8sDeTgy3GSyuoEsiaKC8wSXJqq`  | `1.0.0`     |
| **Testnet**    | Gas Service | **Devnet**     | `gasq7KHHv9Rs8C82hu3dgoBD9wk5LTKpWqbdf5o5juu`  | `1.0.0`     |
| **Testnet**    | Operators   | **Devnet**     | `opriTiaaV7Ew1kma71TjKbrwQ2RWKJ3wbiWEAp3hUZc`  | `1.0.0`     |
| **Testnet**    | Memo        | **Devnet**     | `mem7UJouaeyTgySvXhQSxWtGFrWPQ89jywjc8YvQFRT`  | `1.0.0`     |
| **Testnet**    | Governance  | **Devnet**     | N/A                                            |             |
| **Testnet**    | Multicall   | **Devnet**     | N/A                                            |             |
...
1. Deploy `solana_axelar_gateway` program:

    ```sh
    solana/cli deploy \
        --program gateway \
        --version <VERSION> \
        --program-keypair $GATEWAY_PROGRAM_KEYPAIR_PATH \
        --upgrade-authority $UPGRADE_AUTHORITY_KEYPAIR_PATH
    ```

1. Deploy `solana_axelar_gas_service` program:

    ```sh
    solana/cli deploy \
        --program gas-service \
        --version <VERSION> \
        --program-keypair $GAS_SERVICE_PROGRAM_KEYPAIR_PATH \
        --upgrade-authority $UPGRADE_AUTHORITY_KEYPAIR_PATH
    ```

1. Deploy `solana_axelar_governance` program:

    ```sh
    solana/cli deploy \
        --program governance \
        --version <VERSION> \
        --program-keypair $GOVERNANCE_PROGRAM_KEYPAIR_PATH \
        --upgrade-authority $UPGRADE_AUTHORITY_KEYPAIR_PATH
    ```

1. Deploy `solana_axelar_operators` program:

    ```sh
    solana/cli deploy \
        --program operators \
        --version <VERSION> \
        --program-keypair $OPERATORS_PROGRAM_KEYPAIR_PATH \
        --upgrade-authority $UPGRADE_AUTHORITY_KEYPAIR_PATH
    ```
