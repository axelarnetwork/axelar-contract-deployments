...
1. Declare additional environment variables in your `.env` (ensure custom keypair paths are set correctly):
    ...
    OPERATORS_PROGRAM_PATH="axelar-amplifier-solana/target/deploy/solana_axelar_operators.so"

    MEMO_PROGRAM_KEYPAIR_PATH="<path/to/memo_program_keypair.json>"
    MEMO_PROGRAM_PATH="axelar-amplifier-solana/target/deploy/solana_axelar_memo.so"
