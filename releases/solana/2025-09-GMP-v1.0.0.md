...
1. Deploy and verify axelar_solana_gateway_v2 program:
    ...
    ```sh
    anchor deploy -p axelar_solana_gateway_v2 --provider.cluster $CLUSTER --program-keypair $GATEWAY_PROGRAM_KEYPAIR_PATH -v -- --upgrade-authority $UPGRADE_AUTHORITY_KEYPAIR_PATH
...
1. Deploy and verify axelar_solana_gas_service_v2 program:
    ...
    ```sh
    anchor deploy -p axelar_solana_gas_service_v2 --provider.cluster $CLUSTER --program-keypair $GAS_SERVICE_PROGRAM_KEYPAIR_PATH -v -- --upgrade-authority $UPGRADE_AUTHORITY_KEYPAIR_PATH
...
1. Deploy and verify axelar_solana_memo_v2 program:
    ...
    ```sh
    anchor deploy -p axelar_solana_memo_v2 --provider.cluster $CLUSTER --program-keypair $MEMO_PROGRAM_KEYPAIR_PATH -v -- --upgrade-authority $UPGRADE_AUTHORITY_KEYPAIR_PATH
