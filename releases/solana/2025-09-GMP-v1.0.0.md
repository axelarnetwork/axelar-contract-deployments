...
1. Deploy and verify `solana_axelar_gateway` program:
    ...
    ```sh
    anchor deploy -p solana_axelar_gateway --provider.cluster $CLUSTER --program-keypair $GATEWAY_PROGRAM_KEYPAIR_PATH --provider.wallet $UPGRADE_AUTHORITY_KEYPAIR_PATH -- --upgrade-authority $UPGRADE_AUTHORITY_KEYPAIR_PATH
...
1. Deploy and verify `solana_axelar_gas_service` program:
    ...
    ```sh
    anchor deploy -p solana_axelar_gas_service --provider.cluster $CLUSTER --program-keypair $GAS_SERVICE_PROGRAM_KEYPAIR_PATH --provider.wallet $UPGRADE_AUTHORITY_KEYPAIR_PATH -- --upgrade-authority $UPGRADE_AUTHORITY_KEYPAIR_PATH
...
1. Deploy and verify `solana_axelar_governance` program:
    ...
    ```sh
    anchor deploy -p solana_axelar_governance --provider.cluster $CLUSTER --program-keypair $GOVERNANCE_PROGRAM_KEYPAIR_PATH --provider.wallet $UPGRADE_AUTHORITY_KEYPAIR_PATH -- --upgrade-authority $UPGRADE_AUTHORITY_KEYPAIR_PATH
...
1. Deploy and verify `solana_axelar_multicall` program:
    ...
    ```sh
    anchor deploy -p solana_axelar_multicall --provider.cluster $CLUSTER --program-keypair $MULTICALL_PROGRAM_KEYPAIR_PATH --provider.wallet $UPGRADE_AUTHORITY_KEYPAIR_PATH -- --upgrade-authority $UPGRADE_AUTHORITY_KEYPAIR_PATH
...
1. Deploy and verify `solana_axelar_operators` program:
    ...
    ```sh
    anchor deploy -p solana_axelar_operators --provider.cluster $CLUSTER --program-keypair $OPERATORS_PROGRAM_KEYPAIR_PATH --provider.wallet $UPGRADE_AUTHORITY_KEYPAIR_PATH -- --upgrade-authority $UPGRADE_AUTHORITY_KEYPAIR_PATH
...
1. Deploy and verify `solana_axelar_memo` program:
    ...
    ```sh
    anchor deploy -p solana_axelar_memo --provider.cluster $CLUSTER --program-keypair $MEMO_PROGRAM_KEYPAIR_PATH --provider.wallet $UPGRADE_AUTHORITY_KEYPAIR_PATH -- --upgrade-authority $UPGRADE_AUTHORITY_KEYPAIR_PATH
