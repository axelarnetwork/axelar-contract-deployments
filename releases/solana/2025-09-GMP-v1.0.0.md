...
| -------------------- | ----------- | -------------- | --------------------------------------------- |
| **Devnet Amplifier** | Gateway     | **Devnet**     | `gtwnxC45HVxnYSYaAyEAynqyJ7ngy6ovwccK5SZniXs` |
| **Devnet Amplifier** | Gas Service | **Devnet**     | `gas3uijapeWgj4vtEdCH8Buz8kXKfdMGcDWHQU4yz2F` |
| **Devnet Amplifier** | Governance  | **Devnet**     | `govUb43dsUx9XNWB2QTrcystyRmr6q3ALoGZE69Hsqz` |
| **Devnet Amplifier** | Multicall   | **Devnet**     | `` |
| **Devnet Amplifier** | Operators   | **Devnet**     | `oprWnVUpS2svpRDYJLSmjm5Y8GthYMkdqvjtMTuz5Hb` |
| **Devnet Amplifier** | Memo        | **Devnet**     | `memxcyeft9F1uURRna2o9w8KPitBKMx5nMT6m26Aq9X` |
