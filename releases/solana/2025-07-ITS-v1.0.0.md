...
The $UPGRADE_AUTHORITY_KEYPAIR_PATH and other required contract role related required keys were pre-generated for each environment. Access to those are secured and only maintainers have access to them.
