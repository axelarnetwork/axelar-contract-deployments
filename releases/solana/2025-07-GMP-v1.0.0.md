...
| Environment |    Role Keypair     |                    Address                    |
| :---------: | :-----------------: | :-------------------------------------------: |
|   Devnet    |  Gateway Operator   | `gopDbjxoihakmMHEbNqyh32Fk3az3Pcuv9jeEhDTr3k` |
|   Devnet    | Governance Operator | `goprHUTruHRTs2Lhmxg5zMwH8fR2wBfmn5LAEbdTmYv` |
|   Devnet    |  Upgrade authority  | `upaFrJck9TeFUXW62r2dDJtBxcMa4ArVjQ49sJeGDVw` |
