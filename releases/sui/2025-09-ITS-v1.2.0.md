...
MINT_BURN_TYPE=4 
ts-node evm/interchainTokenFactory --action registerCustomToken --tokenAddress [tokenAddress] --tokenManagerType $MINT_BURN_TYPE --operator [tokenManager] --salt "salt12345"  [chain]
...
ts-node sui/its link-coin TST [destinationChain] [destinationAddress] --tokenManagerMode ['lock_unlock' | 'mint_burn'] --destinationOperator [tokenManager]

# Example
# ts-node sui/its link-coin TEST avalanche 0xD9445695778773a7FFDA4DcD1cCAD90bA6d016E7 --tokenManagerMode mint_burn --destinationOperator 0xfC79F47A3B28412C289cC24943488D657b08d9e7
```
