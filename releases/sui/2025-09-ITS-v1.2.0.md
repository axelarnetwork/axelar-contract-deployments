...
```bash
ts-node evm/interchainTokenFactory --action linkToken --destinationChain sui --destinationTokenAddress $SUI_COIN_TYPE --tokenManagerType $MINT_BURN_FROM --linkParams "0x" --salt $SALT -n avalanche
# ts-node evm/interchainTokenFactory --action linkToken --destinationChain sui --destinationTokenAddress "4d04e01b9bc1775cfe97a89f367d1c822fb55c21850e6e2813349e6f422bb451::dtcoin::DTCOIN" --tokenManagerType 1 --linkParams "0x" --salt "realSaltDtCoin01" -n avalanche
