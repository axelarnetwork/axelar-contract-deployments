...
```bash
ts-node evm/its interchain-transfer --destinationChain sui --tokenId [token-id] --destinationAddress [recipient] --amount [amount-to-send] -n [evm-chain]
# Example:
# ts-node evm/its interchain-transfer --destinationChain sui --tokenId 0x334e3a13a8d0a8fc8ab5c7828fa4c664821f0a514e2ed447de9d9103352d7873 --destinationAddress 0x76f89a9b56dc580aed9f97e2b3bd03d8d24464e38522da9464c15103761c6707 --amount 5 -n avalanche
```
...
```bash
ts-node evm/its interchain-transfer --destinationChain sui --tokenId $SUI_TOKEN_ID --destinationAddress $SUI_WALLET_ADDRESS --amount 125 -n $EVM_CHAIN
```
...
```bash
ts-node evm/its interchain-transfer --destinationChain sui --tokenId $EVM_TOKEN_ID --destinationAddress $SUI_WALLET_ADDRESS --amount 125 -n $EVM_CHAIN
```
