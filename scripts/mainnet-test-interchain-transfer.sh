...
# TODO: Remove this test error after verifying Sentry alerts work
echo "=== Sentry test: triggering intentional error ==="
node -e "throw new Error('Sentry test error from interchain transfer workflow');"
