...
async function addOperator(
  ...
  const ownerCapObjectId =
    options.ownerCapId || contractConfig.objects.OwnerCap;
  ...
  tx.moveCall({
    ...
    arguments: [
      tx.object(operatorsObjectId),
      tx.object(ownerCapObjectId),
      tx.pure.address(newOperatorAddress),
    ],
  });
...
if (require.main === module) {
  ...
  program.addCommand(
    new Command("add")
      ...
      .addOption(
        new Option("--ownerCap <ownerCapId>", "ID of the owner capability"),
      )
      .action((newOperatorAddress, options) =>
        mainProcessor(addOperator, [newOperatorAddress], options),
      ),
  );
  ...
  program.addCommand(
    new Command("remove")
      ...
      .action((operatorAddress, options) =>
        mainProcessor(removeOperator, [operatorAddress], options),
      ),
  );
  ...
  program.addCommand(
    new Command("collectGas")
      ...
      .action((options) =>
        mainProcessor(collectGas, [options.amount], options),
      ),
  );
  ...
  program.addCommand(
    new Command("removeCap")
      ...
      .addOption(
        new Option("--receiver <receiver>", "The removed cap receiver address"),
      )
  ...
  program.addCommand(
    new Command("refund")
      ...
      .action((messageId, options) =>
        mainProcessor(refund, [messageId], options),
      ),
  );
