...
if (require.main === module) {
  ...
  program
    ...
    .description("Transfer object to recipient address");

  addExtendedOptions(program, { contractName: true });

  program.addOption(
    new Option("--objectId <objectId>", "object id to be transferred"),
  );
  program.addOption(
    new Option("--objectName <objectName>", "object name to be transferred"),
  );
  program.addOption(
    new Option(
      "--recipient <recipient>",
      "recipient to transfer object to",
