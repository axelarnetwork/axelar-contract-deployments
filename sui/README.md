...
-   Ensure that same move folder is present in `sui` directory which was generated during contract deployment phase. `move` folder generated by other methods will result in failure of script
