...
async function processCommand(_, chain, options) {
  printInfo(
    "This script is for testing deployment, not for deployment in production",
  );
  ...
  const gateway = new Contract(
    gatewayAddress,
    getContractJSON("AxelarGateway").abi,
    provider,
  );
...
if (require.main === module) {
  ...
  program
    ...
    .description(
      "Deploy a native wrapped token and integrate with AxelarGateway in order to test AxelarDepositService deployment",
    );
  program.addOption(
