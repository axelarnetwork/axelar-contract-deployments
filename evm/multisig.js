    ...
    switch (multisigAction) {
        ...
        case 'withdraw': {
            ...
            if (!yes) {
                ...
                if (answer !== 'y') {
                    await preExecutionChecks(multisigContract, multisigAction, wallet, recipient, '0x', withdrawAmount);
                }
            }
            ...
            const tx = await multisigContract.withdraw(recipient, withdrawAmount);
            await tx.wait();
            break;
        }
