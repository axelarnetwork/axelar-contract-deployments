...
async function processCommand(_axelar, chain, chains, action, options) {
    ...
    switch (action) {
        ...
        case 'interchain-transfer': {
            ...
            const gasValue = await estimateITSFee(chain, destinationChain, env, 'InterchainTransfer', options.gasValue);
        ...
        case 'register-token-metadata':
            ...
            const gasValue = await estimateITSFee(chain, 'axelar', env, 'TokenMetadataRegistered', options.gasValue);
