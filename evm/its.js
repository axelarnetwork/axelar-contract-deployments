...
async function processCommand(axelar, chain, chains, action, options) {
    ...
    switch (action) {
        ...
        case 'link-token': {
            ...
            const tokenManagerType = validateLinkType(getChainConfigByAxelarId(axelar, destinationChain).chainType, type);
