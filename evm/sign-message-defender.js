...
if (require.main === module) {
  ...
  program
    ...
    .description(
      "Generate signed message using defender's api. Useful for token ownership verification on explorers.",
    );

  program.addOption(
    new Option("-k, --apiKey <api key>", "api key of defender-relay-client")
  ...
  program.addOption(
    new Option(
      "-s, --secret <secret>",
      "secret of api key of defender-relay-client",
    )
      .makeOptionMandatory(true)
      .env("DEFENDER_SECRET"),
  );
