...
pub enum Instruction {
    ...
    TransferOperatorship(RoleManagementInstructionInputs),
    ...
    ProposeOperatorship(RoleManagementInstructionInputs),
    ...
    ///    operatorship is being transferred from.
    /// 8. [writable] PDA for the proposal
    AcceptOperatorship(RoleManagementInstructionInputs),
}
