...
use axelar_solana_memo_program_old::instruction::from_axelar_to_solana::build_memo;
...
async fn test_successful_validate_message(#[case] encoding_scheme: EncodingScheme) {
    ...
    let destination_program_id = axelar_solana_memo_program_old::id();
    let memo_string = "🐪🐪🐪🐪";
    ...
    let counter_account = solana_chain
        .fixture
        .get_account::<axelar_solana_memo_program_old::state::Counter>(
            &counter_pda,
