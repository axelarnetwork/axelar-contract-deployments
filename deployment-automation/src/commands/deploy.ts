...
export function saveDeploymentConfig(): void {
  const configKeys = [
    ...
    'CREATE_MULTISIG_REWARD_POOL_PROPOSAL_ID','GAS_SERVICE_ADDRESS', 'OPERATORS_CONTRACT_ADDRESS',
    'CHAIN_FINALITY', 'CHAIN_CONFIRMATIONS', 'CHAIN_APPROX_FINALITY_WAIT_TIME',
    'AMPD_FINALITY', 'AXELAR_MULTISIG_ADDRESS'
  ];
