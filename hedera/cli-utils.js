...
const addBaseOptions = (program, options = {}) => {
    ...
    program.addOption(new Option('-hn, --hederaNetwork <hederaNetworkName>', 'hedera network').makeOptionMandatory(true).choices(['mainnet', 'testnet', 'previewnet', 'local']).env('HEDERA_NETWORK'));
...
const printHederaNetwork = ({ hederaNetwork, accountId }) => {
	console.log(`Using Hedera ${hederaNetwork}, Account ID ${accountId}`)
};
